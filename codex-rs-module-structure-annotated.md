...
- Workspace members (crates): **105**（实时值，2026-09-10 重新统计；快照时点为 137，经多轮清理共移除 32 个）
- 代码统计（2026-09-10，Python 脚本 `count_code_stats.py`，不含 `.md`）：
  - `.rs`: **2,083** 文件 / **866,150** 行
  - `.ts`: **691** 文件 / **7,529** 行
  - `.json`: **328** 文件 / **147,244** 行
  - 其他格式: **532** 文件 / **39,242** 行
  - 合计: **3,634** 文件 / **1,060,165** 行
