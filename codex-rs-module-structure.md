# Codex Rust Workspace — Module Structure

> Auto-generated by `analyze_codex_modules.py` on 2026-08-27 11:20 UTC.

## Overview

- Workspace root: `codex-rs`
- Workspace members (crates): **137**
- Total `.rs` files: **3392**
- Total `.rs` lines: **1,520,560**

## Crates

| Crate | Path | Description | `.rs` files | Lines | Modules | Root |
|---|---|---|---:|---:|---:|---|
| `codex-agent-graph-store` | `codex-rs/agent-graph-store` | — | 5 | 479 | 6 | `codex-rs/agent-graph-store/src/lib.rs` |
| `codex-agent-identity` | `codex-rs/agent-identity` | — | 1 | 1,000 | 1 | `codex-rs/agent-identity/src/lib.rs` |
| `codex-agent-roles` | `codex-rs/agent-roles` | — | 4 | 592 | 3 | `codex-rs/agent-roles/src/lib.rs` |
| `codex-analytics` | `codex-rs/analytics` | — | 9 | 14,324 | 10 | `codex-rs/analytics/src/lib.rs` |
| `codex-ansi-escape` | `codex-rs/ansi-escape` | — | 1 | 58 | 0 | `codex-rs/ansi-escape/src/lib.rs` |
| `codex-app-server` | `codex-rs/app-server` | — | 248 | 156,315 | 128 | `codex-rs/app-server/src/lib.rs` |
| `codex-app-server-client` | `codex-rs/app-server-client` | — | 3 | 3,143 | 7 | `codex-rs/app-server-client/src/lib.rs` |
| `codex-app-server-daemon` | `codex-rs/app-server-daemon` | — | 11 | 3,552 | 14 | `codex-rs/app-server-daemon/src/lib.rs` |
| `codex-app-server-protocol` | `codex-rs/app-server-protocol` | — | 57 | 33,360 | 62 | `codex-rs/app-server-protocol/src/lib.rs` |
| `codex-app-server-protocol-noop-macros` | `codex-rs/app-server-protocol-noop-macros` | — | 1 | 20 | 0 | `codex-rs/app-server-protocol-noop-macros/src/lib.rs` |
| `codex-app-server-test-client` | `codex-rs/app-server-test-client` | — | 9 | 4,081 | 7 | `codex-rs/app-server-test-client/src/lib.rs` |
| `codex-app-server-transport` | `codex-rs/app-server-transport` | — | 26 | 16,305 | 32 | `codex-rs/app-server-transport/src/lib.rs` |
| `codex-apply-patch` | `codex-rs/apply-patch` | — | 16 | 5,929 | 12 | `codex-rs/apply-patch/src/lib.rs` |
| `codex-arg0` | `codex-rs/arg0` | — | 1 | 810 | 1 | `codex-rs/arg0/src/lib.rs` |
| `codex-async-utils` | `codex-rs/async-utils` | — | 1 | 86 | 1 | `codex-rs/async-utils/src/lib.rs` |
| `codex-aws-auth` | `codex-rs/aws-auth` | — | 4 | 522 | 4 | `codex-rs/aws-auth/src/lib.rs` |
| `codex-backend-client` | `codex-rs/backend-client` | — | 9 | 2,750 | 11 | `codex-rs/backend-client/src/lib.rs` |
| `codex-build-info` | `codex-rs/build-info` | — | 2 | 256 | 1 | `codex-rs/build-info/src/lib.rs` |
| `codex-bwrap` | `codex-rs/bwrap` | — | 2 | 151 | 0 | `codex-rs/bwrap/src/main.rs` |
| `codex-cli` | `codex-rs/cli` | — | 76 | 32,378 | 10 | `codex-rs/cli/src/lib.rs` |
| `codex-cloud-config` | `codex-rs/cloud-config` | — | 9 | 2,917 | 8 | `codex-rs/cloud-config/src/lib.rs` |
| `codex-cloud-tasks` | `codex-rs/cloud-tasks` | — | 11 | 5,329 | 11 | `codex-rs/cloud-tasks/src/lib.rs` |
| `codex-cloud-tasks-client` | `codex-rs/cloud-tasks-client` | — | 3 | 1,117 | 3 | `codex-rs/cloud-tasks-client/src/lib.rs` |
| `codex-cloud-tasks-mock-client` | `codex-rs/cloud-tasks-mock-client` | — | 2 | 270 | 1 | `codex-rs/cloud-tasks-mock-client/src/lib.rs` |
| `codex-code-mode` | `codex-rs/code-mode` | — | 30 | 8,635 | 29 | `codex-rs/code-mode/src/lib.rs` |
| `codex-code-mode-host` | `codex-rs/code-mode-host` | — | 28 | 8,125 | 19 | `codex-rs/code-mode-host/src/lib.rs` |
| `codex-code-mode-protocol` | `codex-rs/code-mode-protocol` | — | 18 | 4,332 | 17 | `codex-rs/code-mode-protocol/src/lib.rs` |
| `codex-code-mode-runtime` | `codex-rs/code-mode-runtime` | — | 21 | 7,121 | 20 | `codex-rs/code-mode-runtime/src/lib.rs` |
| `codex-api` | `codex-rs/codex-api` | — | 46 | 15,484 | 54 | `codex-rs/codex-api/src/lib.rs` |
| `codex-backend-openapi-models` | `codex-rs/codex-backend-openapi-models` | — | 21 | 1,021 | 20 | `codex-rs/codex-backend-openapi-models/src/lib.rs` |
| `codex-client` | `codex-rs/codex-client` | — | 4 | 183 | 3 | `codex-rs/codex-client/src/lib.rs` |
| `codex-experimental-api-macros` | `codex-rs/codex-experimental-api-macros` | — | 1 | 310 | 0 | `codex-rs/codex-experimental-api-macros/src/lib.rs` |
| `codex-home` | `codex-rs/codex-home` | — | 3 | 227 | 2 | `codex-rs/codex-home/src/lib.rs` |
| `codex-mcp` | `codex-rs/codex-mcp` | — | 43 | 20,476 | 46 | `codex-rs/codex-mcp/src/lib.rs` |
| `codex-collaboration-mode-templates` | `codex-rs/collaboration-mode-templates` | — | 1 | 2 | 0 | `codex-rs/collaboration-mode-templates/src/lib.rs` |
| `codex-config` | `codex-rs/config` | — | 72 | 25,451 | 84 | `codex-rs/config/src/lib.rs` |
| `codex-connectors` | `codex-rs/connectors` | — | 20 | 4,961 | 22 | `codex-rs/connectors/src/lib.rs` |
| `codex-context-fragments` | `codex-rs/context-fragments` | — | 4 | 346 | 3 | `codex-rs/context-fragments/src/lib.rs` |
| `codex-core` | `codex-rs/core` | — | 607 | 347,184 | 495 | `codex-rs/core/src/lib.rs` |
| `codex-core-api` | `codex-rs/core-api` | — | 1 | 135 | 0 | `codex-rs/core-api/src/lib.rs` |
| `codex-core-plugins` | `codex-rs/core-plugins` | — | 73 | 42,732 | 81 | `codex-rs/core-plugins/src/lib.rs` |
| `codex-diagnostics` | `codex-rs/diagnostics` | — | 2 | 268 | 1 | `codex-rs/diagnostics/src/lib.rs` |
| `codex-exec` | `codex-rs/exec` | — | 31 | 11,040 | 9 | `codex-rs/exec/src/lib.rs` |
| `codex-exec-server` | `codex-rs/exec-server` | — | 133 | 49,717 | 122 | `codex-rs/exec-server/src/lib.rs` |
| `codex-exec-server-protocol` | `codex-rs/exec-server-protocol` | — | 8 | 2,045 | 9 | `codex-rs/exec-server-protocol/src/lib.rs` |
| `codex-exec-server-test-support` | `codex-rs/exec-server/tests/support` | — | 2 | 125 | 3 | `codex-rs/exec-server/tests/support/lib.rs` |
| `codex-execpolicy` | `codex-rs/execpolicy` | Codex exec policy: prefix-based Starlark rules for command decisions. | 13 | 2,975 | 11 | `codex-rs/execpolicy/src/lib.rs` |
| `codex-agent-extension` | `codex-rs/ext/agent` | — | 2 | 170 | 0 | `codex-rs/ext/agent/src/lib.rs` |
| `codex-connectors-extension` | `codex-rs/ext/connectors` | — | 2 | 76 | 1 | `codex-rs/ext/connectors/src/lib.rs` |
| `codex-extension-api` | `codex-rs/ext/extension-api` | — | 27 | 2,993 | 21 | `codex-rs/ext/extension-api/src/lib.rs` |
| `codex-git-attribution` | `codex-rs/ext/git-attribution` | — | 4 | 441 | 3 | `codex-rs/ext/git-attribution/src/lib.rs` |
| `codex-goal-extension` | `codex-rs/ext/goal` | — | 13 | 4,570 | 10 | `codex-rs/ext/goal/src/lib.rs` |
| `codex-guardian-v2` | `codex-rs/ext/guardian-v2` | — | 23 | 10,433 | 22 | `codex-rs/ext/guardian-v2/src/lib.rs` |
| `codex-history-notes-extension` | `codex-rs/ext/history-notes` | — | 7 | 1,241 | 5 | `codex-rs/ext/history-notes/src/lib.rs` |
| `codex-image-generation-extension` | `codex-rs/ext/image-generation` | — | 6 | 1,318 | 5 | `codex-rs/ext/image-generation/src/lib.rs` |
| `codex-extension-items` | `codex-rs/ext/items` | — | 5 | 370 | 4 | `codex-rs/ext/items/src/lib.rs` |
| `codex-mcp-extension` | `codex-rs/ext/mcp` | — | 8 | 1,720 | 5 | `codex-rs/ext/mcp/src/lib.rs` |
| `codex-memories-extension` | `codex-rs/ext/memories` | — | 19 | 2,506 | 18 | `codex-rs/ext/memories/src/lib.rs` |
| `codex-queue-extension` | `codex-rs/ext/queue` | — | 3 | 1,615 | 1 | `codex-rs/ext/queue/src/lib.rs` |
| `codex-skills-extension` | `codex-rs/ext/skills` | — | 82 | 22,063 | 78 | `codex-rs/ext/skills/src/lib.rs` |
| `codex-web-search-extension` | `codex-rs/ext/web-search` | — | 6 | 882 | 9 | `codex-rs/ext/web-search/src/lib.rs` |
| `codex-external-agent-migration` | `codex-rs/external-agent-migration` | — | 64 | 16,354 | 66 | `codex-rs/external-agent-migration/src/lib.rs` |
| `codex-features` | `codex-rs/features` | — | 4 | 3,054 | 3 | `codex-rs/features/src/lib.rs` |
| `codex-feedback` | `codex-rs/feedback` | — | 2 | 1,377 | 3 | `codex-rs/feedback/src/lib.rs` |
| `codex-file-search` | `codex-rs/file-search` | — | 3 | 1,346 | 2 | `codex-rs/file-search/src/lib.rs` |
| `codex-file-system` | `codex-rs/file-system` | — | 2 | 683 | 1 | `codex-rs/file-system/src/lib.rs` |
| `codex-file-watcher` | `codex-rs/file-watcher` | — | 2 | 1,492 | 1 | `codex-rs/file-watcher/src/lib.rs` |
| `codex-git-utils` | `codex-rs/git-utils` | — | 15 | 4,431 | 18 | `codex-rs/git-utils/src/lib.rs` |
| `codex-history` | `codex-rs/history` | — | 3 | 1,253 | 2 | `codex-rs/history/src/lib.rs` |
| `codex-hooks` | `codex-rs/hooks` | — | 34 | 15,037 | 49 | `codex-rs/hooks/src/lib.rs` |
| `codex-http-client` | `codex-rs/http-client` | — | 27 | 8,999 | 29 | `codex-rs/http-client/src/lib.rs` |
| `codex-install-context` | `codex-rs/install-context` | — | 1 | 867 | 1 | `codex-rs/install-context/src/lib.rs` |
| `codex-keyring-store` | `codex-rs/keyring-store` | — | 1 | 226 | 1 | `codex-rs/keyring-store/src/lib.rs` |
| `codex-linux-sandbox` | `codex-rs/linux-sandbox` | — | 21 | 9,846 | 19 | `codex-rs/linux-sandbox/src/lib.rs` |
| `codex-lmstudio` | `codex-rs/lmstudio` | — | 2 | 470 | 2 | `codex-rs/lmstudio/src/lib.rs` |
| `codex-login` | `codex-rs/login` | — | 42 | 16,330 | 40 | `codex-rs/login/src/lib.rs` |
| `codex-mcp-server` | `codex-rs/mcp-server` | — | 20 | 4,165 | 15 | `codex-rs/mcp-server/src/lib.rs` |
| `codex-memories-read` | `codex-rs/memories/read` | — | 5 | 232 | 4 | `codex-rs/memories/read/src/lib.rs` |
| `codex-memories-write` | `codex-rs/memories/write` | — | 23 | 4,891 | 36 | `codex-rs/memories/write/src/lib.rs` |
| `codex-model-provider` | `codex-rs/model-provider` | — | 17 | 4,776 | 24 | `codex-rs/model-provider/src/lib.rs` |
| `codex-model-provider-info` | `codex-rs/model-provider-info` | — | 2 | 1,302 | 1 | `codex-rs/model-provider-info/src/lib.rs` |
| `codex-models-manager` | `codex-rs/models-manager` | — | 12 | 3,195 | 11 | `codex-rs/models-manager/src/lib.rs` |
| `codex-network-proxy` | `codex-rs/network-proxy` | — | 39 | 19,024 | 50 | `codex-rs/network-proxy/src/lib.rs` |
| `codex-ollama` | `codex-rs/ollama` | — | 7 | 1,107 | 10 | `codex-rs/ollama/src/lib.rs` |
| `codex-otel` | `codex-rs/otel` | — | 33 | 8,283 | 26 | `codex-rs/otel/src/lib.rs` |
| `codex-plugin` | `codex-rs/plugin` | — | 7 | 914 | 7 | `codex-rs/plugin/src/lib.rs` |
| `codex-process-hardening` | `codex-rs/process-hardening` | — | 1 | 193 | 1 | `codex-rs/process-hardening/src/lib.rs` |
| `codex-prompts` | `codex-rs/prompts` | — | 9 | 1,474 | 8 | `codex-rs/prompts/src/lib.rs` |
| `codex-protocol` | `codex-rs/protocol` | — | 56 | 27,496 | 70 | `codex-rs/protocol/src/lib.rs` |
| `codex-response-debug-context` | `codex-rs/response-debug-context` | — | 1 | 176 | 1 | `codex-rs/response-debug-context/src/lib.rs` |
| `codex-responses-api-proxy` | `codex-rs/responses-api-proxy` | — | 4 | 1,007 | 4 | `codex-rs/responses-api-proxy/src/lib.rs` |
| `codex-rmcp-client` | `codex-rs/rmcp-client` | — | 74 | 27,536 | 61 | `codex-rs/rmcp-client/src/lib.rs` |
| `codex-rollout` | `codex-rs/rollout` | — | 28 | 15,060 | 32 | `codex-rs/rollout/src/lib.rs` |
| `codex-rollout-trace` | `codex-rs/rollout-trace` | — | 34 | 13,278 | 37 | `codex-rs/rollout-trace/src/lib.rs` |
| `codex-sandboxing` | `codex-rs/sandboxing` | — | 16 | 8,662 | 15 | `codex-rs/sandboxing/src/lib.rs` |
| `codex-secrets` | `codex-rs/secrets` | — | 3 | 970 | 5 | `codex-rs/secrets/src/lib.rs` |
| `codex-shell-command` | `codex-rs/shell-command` | — | 13 | 6,340 | 19 | `codex-rs/shell-command/src/lib.rs` |
| `codex-shell-escalation` | `codex-rs/shell-escalation` | — | 10 | 2,281 | 12 | `codex-rs/shell-escalation/src/lib.rs` |
| `codex-skills` | `codex-rs/skills` | — | 17 | 2,566 | 16 | `codex-rs/skills/src/lib.rs` |
| `codex-state` | `codex-rs/state` | — | 43 | 22,579 | 53 | `codex-rs/state/src/lib.rs` |
| `codex-stdio-to-uds` | `codex-rs/stdio-to-uds` | — | 3 | 223 | 0 | `codex-rs/stdio-to-uds/src/lib.rs` |
| `codex-terminal-detection` | `codex-rs/terminal-detection` | — | 2 | 1,515 | 1 | `codex-rs/terminal-detection/src/lib.rs` |
| `codex-test-binary-support` | `codex-rs/test-binary-support` | — | 1 | 77 | 0 | `codex-rs/test-binary-support/lib.rs` |
| `codex-thread-manager-sample` | `codex-rs/thread-manager-sample` | — | 1 | 417 | 0 | `codex-rs/thread-manager-sample/src/main.rs` |
| `codex-thread-store` | `codex-rs/thread-store` | — | 62 | 31,001 | 73 | `codex-rs/thread-store/src/lib.rs` |
| `codex-tools` | `codex-rs/tools` | — | 32 | 6,966 | 31 | `codex-rs/tools/src/lib.rs` |
| `codex-tui` | `codex-rs/tui` | — | 520 | 288,086 | 661 | `codex-rs/tui/src/lib.rs` |
| `codex-uds` | `codex-rs/uds` | — | 2 | 452 | 3 | `codex-rs/uds/src/lib.rs` |
| `codex-utils-absolute-path` | `codex-rs/utils/absolute-path` | — | 2 | 938 | 4 | `codex-rs/utils/absolute-path/src/lib.rs` |
| `codex-utils-approval-presets` | `codex-rs/utils/approval-presets` | — | 1 | 77 | 0 | `codex-rs/utils/approval-presets/src/lib.rs` |
| `codex-utils-audio` | `codex-rs/utils/audio` | — | 2 | 422 | 1 | `codex-rs/utils/audio/src/lib.rs` |
| `codex-utils-cache` | `codex-rs/utils/cache` | — | 1 | 193 | 1 | `codex-rs/utils/cache/src/lib.rs` |
| `codex-utils-cargo-bin` | `codex-rs/utils/cargo-bin` | — | 1 | 231 | 0 | `codex-rs/utils/cargo-bin/src/lib.rs` |
| `codex-utils-cli` | `codex-rs/utils/cli` | — | 7 | 639 | 10 | `codex-rs/utils/cli/src/lib.rs` |
| `codex-utils-elapsed` | `codex-rs/utils/elapsed` | — | 1 | 71 | 1 | `codex-rs/utils/elapsed/src/lib.rs` |
| `codex-utils-fuzzy-match` | `codex-rs/utils/fuzzy-match` | — | 1 | 168 | 1 | `codex-rs/utils/fuzzy-match/src/lib.rs` |
| `codex-utils-home-dir` | `codex-rs/utils/home-dir` | — | 1 | 134 | 1 | `codex-rs/utils/home-dir/src/lib.rs` |
| `codex-utils-image` | `codex-rs/utils/image` | — | 4 | 1,064 | 2 | `codex-rs/utils/image/src/lib.rs` |
| `codex-utils-json-to-toml` | `codex-rs/utils/json-to-toml` | — | 1 | 83 | 1 | `codex-rs/utils/json-to-toml/src/lib.rs` |
| `codex-utils-oss` | `codex-rs/utils/oss` | — | 1 | 62 | 1 | `codex-rs/utils/oss/src/lib.rs` |
| `codex-utils-output-truncation` | `codex-rs/utils/output-truncation` | — | 2 | 603 | 1 | `codex-rs/utils/output-truncation/src/lib.rs` |
| `codex-utils-path-uri` | `codex-rs/utils/path-uri` | — | 6 | 3,363 | 5 | `codex-rs/utils/path-uri/src/lib.rs` |
| `codex-utils-path` | `codex-rs/utils/path-utils` | — | 3 | 354 | 6 | `codex-rs/utils/path-utils/src/lib.rs` |
| `codex-utils-plugins` | `codex-rs/utils/plugins` | — | 4 | 452 | 4 | `codex-rs/utils/plugins/src/lib.rs` |
| `codex-utils-pty` | `codex-rs/utils/pty` | — | 18 | 5,240 | 17 | `codex-rs/utils/pty/src/lib.rs` |
| `codex-utils-readiness` | `codex-rs/utils/readiness` | — | 1 | 336 | 2 | `codex-rs/utils/readiness/src/lib.rs` |
| `codex-utils-redacted-string` | `codex-rs/utils/redacted-string` | — | 1 | 49 | 0 | `codex-rs/utils/redacted-string/src/lib.rs` |
| `codex-utils-rustls-provider` | `codex-rs/utils/rustls-provider` | — | 3 | 81 | 0 | `codex-rs/utils/rustls-provider/src/lib.rs` |
| `codex-utils-sandbox-summary` | `codex-rs/utils/sandbox-summary` | — | 2 | 186 | 2 | `codex-rs/utils/sandbox-summary/src/lib.rs` |
| `codex-utils-sleep-inhibitor` | `codex-rs/utils/sleep-inhibitor` | — | 6 | 608 | 6 | `codex-rs/utils/sleep-inhibitor/src/lib.rs` |
| `codex-utils-stream-parser` | `codex-rs/utils/stream-parser` | — | 8 | 1,485 | 13 | `codex-rs/utils/stream-parser/src/lib.rs` |
| `codex-utils-string` | `codex-rs/utils/string` | — | 4 | 560 | 5 | `codex-rs/utils/string/src/lib.rs` |
| `codex-utils-template` | `codex-rs/utils/template` | — | 1 | 442 | 1 | `codex-rs/utils/template/src/lib.rs` |
| `codex-v8-poc` | `codex-rs/v8-poc` | — | 1 | 92 | 1 | `codex-rs/v8-poc/src/lib.rs` |
| `codex-websocket-client` | `codex-rs/websocket-client` | — | 3 | 1,160 | 2 | `codex-rs/websocket-client/src/lib.rs` |
| `codex-workload-identity` | `codex-rs/workload-identity` | — | 4 | 870 | 3 | `codex-rs/workload-identity/src/lib.rs` |
| `codex-worktree` | `codex-rs/worktree` | — | 6 | 621 | 3 | `codex-rs/worktree/src/lib.rs` |
